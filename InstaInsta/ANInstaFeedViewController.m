...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    photocontroller.attr_items = self.attr_items;
    photocontroller.items = self.items;
    photocontroller.attrib = self.attrib;
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.imageView setImageWithURL: [NSURL URLWithString:post.images.thumbnail.url] placeholderImage:[UIImage imageNamed:@"Screenshot.png"]];
